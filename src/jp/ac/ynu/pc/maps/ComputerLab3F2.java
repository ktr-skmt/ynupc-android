 ...
 * M.svg
 */
public class ComputerLab3F2 extends RoomMap {
    ...
    public ComputerLab3F2(RoomInfo roomInfo){
    ...
    private String buildSVGString() {
        ...
        builder.append("<path id=\"wall\" fill=\"none\" stroke=\"#000000\" stroke-width=\"3\" d=\"M440,120V90H40v400h400V190\"/>");
        ...
        builder.append(generatePCRect(RECT_WIDTH, RECT_HEIGHT, 60.386f, 341.221f, roomInfo.isPCAvailable(16)));
        builder.append(generatePCRect(RECT_WIDTH, RECT_HEIGHT, 103.88f, 341.221f, roomInfo.isPCAvailable(15)));
        builder.append(generatePCRect(RECT_WIDTH, RECT_HEIGHT, 147.38f, 341.221f, roomInfo.isPCAvailable(14)));
        builder.append(generatePCRect(RECT_WIDTH, RECT_HEIGHT, 190.88f, 341.221f, roomInfo.isPCAvailable(13)));
        builder.append(generatePCRect(RECT_WIDTH, RECT_HEIGHT, 254.25f, 341.221f, roomInfo.isPCAvailable(12)));
        builder.append(generatePCRect(RECT_WIDTH, RECT_HEIGHT, 297.75f, 341.221f, roomInfo.isPCAvailable(11)));
        builder.append(generatePCRect(RECT_WIDTH, RECT_HEIGHT, 341.25f, 341.221f, roomInfo.isPCAvailable(10)));
        builder.append(generatePCRect(RECT_WIDTH, RECT_HEIGHT, 384.74f, 341.221f, roomInfo.isPCAvailable(9)));
        builder.append(generatePCRect(RECT_WIDTH, RECT_HEIGHT, 60.386f, 292.061f, roomInfo.isPCAvailable(17)));
        builder.append(generatePCRect(RECT_WIDTH, RECT_HEIGHT, 103.88f, 292.061f, roomInfo.isPCAvailable(18)));
        builder.append(generatePCRect(RECT_WIDTH, RECT_HEIGHT, 147.38f, 292.061f, roomInfo.isPCAvailable(19)));
        builder.append(generatePCRect(RECT_WIDTH, RECT_HEIGHT, 190.88f, 292.061f, roomInfo.isPCAvailable(20)));
